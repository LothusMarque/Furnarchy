...
// (DO NOT EDIT: machine generated header) 'Gr32_image.pas' rev: 10.00
...
typedef DynamicArray<TPaintStage >  GR32_Image__2;
...
#pragma option push -b-
enum GR32_Image__3 { pboWantArrowKeys, pboAutoFocus };
#pragma option pop

typedef Set<GR32_Image__3, pboWantArrowKeys, pboAutoFocus>  TPaintBoxOptions;
...
typedef DynamicArray<TPaintStageHandler >  GR32_Image__7;

typedef DynamicArray<int >  GR32_Image__8;
...
private:
	...
	DynamicArray<TPaintStageHandler >  FPaintStageHandlers;
	DynamicArray<int >  FPaintStageNum;
	float FScaleX;
	float FScaleY;
	...
	void __fastcall LayerCollectionGetViewportScaleHandler(System::TObject* Sender, float &ScaleX, float &ScaleY);
	void __fastcall LayerCollectionGetViewportShiftHandler(System::TObject* Sender, float &ShiftX, float &ShiftY);
